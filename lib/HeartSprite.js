HeartSprite = function(position, clickBehavior) {
    ...
    this.ResetSprite = function() {
        ...
        this.sprite.position.y = (camera.position.y + Math.random()*50 - 25);
        this.sprite.position.z = (camera.position.z + Math.random()*50 - 30);


        //TweenLite.to(this.sprite.scale, 1.0, {x: "1.0", y: "1.0"});
